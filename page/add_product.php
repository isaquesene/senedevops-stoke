...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 15:23:54 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/logo/_LOGO_1.png" type="image/x-icon">
    <link rel="shortcut icon" href="../assets/images/logo/_LOGO_1.png" type="image/x-icon">
    <title>STOKE admin dashboard </title>
    <!-- Google font-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0"> 
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="#"><img class="img-fluid" src="../assets/images/logo/_LOGO_1.png" alt=""></a></div>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper"> 
          <div>
            <div class="logo-wrapper"><a href="#"><label class="img-fluid for-light" src="#" alt="">SENEDEVOPS - STOKE</label><label class="img-fluid for-dark" src="#" alt="">SENEDEVOPS - STOKE</label></a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="#"><img class="img-fluid" src="../assets/images/_LOGO_1.png" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="#"><img class="img-fluid" src="../assets/images/_LOGO_1.png" alt=""></a>
                    <div class="mobile-back text-end"><span>Back</span></div>
                  </li>
                  <li class="sidebar-list">
                    <label class="badge badge-light-primary"></label><a class="sidebar-link sidebar-title" href="home.php">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                ...
                <div class="sidebar-img-section">
                  <div class="sidebar-img-content" style="background-color: #090522;"><img class="img-fluid" src="../assets/images/_LOGO_1.png" alt="">
                    <h4>Precisa de Ajuda?</h4><a class="txt" href="#">Entre em conatato no botão abaixo!"</a><a class="btn btn-secondary" href="#">Contato</a>
                  </div>
                </div>
              </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Web and Software Developer 2023 © SeneDevops</p>
              </div>
            </div>
          </div>
        </footer>
