                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    com suporte de treinamento técnico sobre a plataforma. 
                                </p>
                                <p class="card-text">
                                    Seja bem-vindo e aproveito nosso sistema.
                                    By SeneDevops.
                                </p>
                                <a href="home.php" class="btn btn-primary block">Começar</a>
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <!--  <div class="row">
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4>Medicamentos mais prescritos</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover table-lg">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <p class="font-bold ms-3 mb-0">Loratadina</p>
                                                    </div>
                                                </td>
                                                <td class="col-auto">
                                                    <p class=" mb-0">Detalhes da prescrição!</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-3">
                                                        <p class="font-bold ms-3 mb-0">Omeprazou</p>
                                                    </div>
                                                </td>
                                                <td class="col-auto">
                                                    <p class=" mb-0">Detalhes da prescrição?</p>
